...
const translations = {
  pt: {
    ...
    wifiCamera: {
      ...
      noResultsDetailsSanity: 'Sanity 192.168.0.14: {{status}}',
      sanityAlive: 'respondeu',
      sanityDead: 'sem resposta',
      sanitySkipped: 'nao executado',
  ...
  en: {
    ...
    wifiCamera: {
      ...
      noResultsDetailsSanity: 'Sanity 192.168.0.14: {{status}}',
      sanityAlive: 'reachable',
      sanityDead: 'no response',
      sanitySkipped: 'not executed',
