      ...
      <ScrollView contentContainerStyle={styles.scrollContentContainer}>
        <View style={styles.container}>
          ...
          <Text style={styles.mainSubtitle}>
            Siga estas dicas para garantir uma contagem precisa e eficiente com
            nosso app.
          </Text>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionText}>
              A câmera deve estar bem posicionada para uma visão clara e de cima
              da passagem do gado.
            </Text>
            ...
            <View style={styles.point}>
              ...
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Visão de Cima (Top-Down):</Text>{' '}
                Posicione a câmera diretamente ACIMA da porteira ou corredor. A
                visão deve ser de cima para baixo, o mais reto possível.
              </Text>
            </View>
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>🎯</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Cobertura Total:</Text> Garanta que a
                câmera filme TODA a largura da passagem onde o gado irá cruzar.
                Nenhum animal deve passar por fora do campo de visão.
              </Text>
            </View>
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>🚫</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Câmera Estável:</Text> Use um suporte,
                tripé ou fixe a câmera de forma segura. Vídeos tremidos
                prejudicam a precisão!
              </Text>
            </View>
            <Text style={styles.tipText}>
              <Text style={styles.bold}>Dica de Altura:</Text> Para uma porteira
              padrão de ~3 metros de largura, uma altura de câmera entre 2 a 3
              metros geralmente oferece um bom enquadramento com a maioria dos
              celulares. Teste para encontrar o ideal para seu equipamento e
              porteira.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              🎬 2. Dicas para uma Filmagem Eficaz
            </Text>
            ...
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>➡️</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Passagem Completa:</Text> Filme cada
                animal passando COMPLETAMENTE pela área visível, do momento que
                entra até o momento que sai do enquadramento da câmera.
              </Text>
            </View>
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>☀️</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Boa Iluminação:</Text> Prefira filmar
                com boa luz natural e uniforme. Evite o sol diretamente na
                lente, sombras muito fortes sobre os animais ou escuridão
                excessiva.
              </Text>
            </View>
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>⏱️</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Foco no Momento Certo:</Text> Grave
                apenas o período de passagem do gado. Evite vídeos
                desnecessariamente longos antes ou depois do evento.
              </Text>
            </View>
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>✨</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Qualidade de Vídeo:</Text> Use uma boa
                qualidade (ex: HD 720p ou Full HD 1080p). Arquivos muito grandes
                (4K por muito tempo) podem demorar mais para enviar e processar.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>↔️</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Linha de Contagem Virtual:</Text>{' '}
                Nosso sistema utiliza uma linha de referência no seu vídeo para
                detectar quando um animal cruza.
              </Text>
            </View>
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>↕️</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Direção do Movimento:</Text> É
                importante que o gado se mova em uma direção principal (ex: da
                esquerda para a direita, ou de cima para baixo na tela) ao
                cruzar a linha. O app poderá perguntar essa direção ou usar um
                padrão.
              </Text>
            </View>
            <View style={styles.point}>
              <Text style={styles.pointEmoji}>✅</Text>
              <Text style={styles.pointText}>
                <Text style={styles.bold}>Contagem Única:</Text> Cada animal que
                cruzar a linha na direção configurada será contado uma única
                vez.
              </Text>
            </View>
          </View>
